...
class GrobotEyes{
    ...
    private:
        ...
        //lid definition
        float currentLidHeight = 0;
        float targetLidHeight = 0; //0: no eyelid  , 90: full eyelid
        ...
        float canvasX = 0, canvasY = 60;
        float targetCanvasX = 0, targetCanvasY = 60;
        ...
        void applySpring(float &current, float &velocity, float target, float dt, float stiffness= 180.0, float damping = 15.0);
